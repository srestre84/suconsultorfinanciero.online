    ...
    return (
        <main className="calculator-detail-page">
            <Helmet>
                ...
                <meta property="og:image:secure_url" content="https://suconsultorfinanciero.online/calculator-preview.png" />
                ...
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div className="share-links-top" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginBottom: '2rem' }}>
                        ...
                        {navigator.share ? (
                            ...
                            <>
                                <button onClick={() => window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(shareMessage + ' ' + currentUrl)}`, '_blank')} className="prop-share-btn prop-share-btn--ws" style={{ width: '35px', height: '35px' }}>
                                ...
                                <button onClick={() => { navigator.clipboard.writeText(shareMessage + ' ' + currentUrl); alert('¡Copiado!'); }} className="prop-share-btn prop-share-btn--copy" style={{ width: '35px', height: '35px' }}>
