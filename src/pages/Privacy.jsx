    ...
    return (
        <div className="container" style={{ padding: '4rem 2rem', maxWidth: '800px', margin: '0 auto', color: '#444' }}>
            <div className="glass" style={{ padding: '3rem', borderRadius: '20px' }}>
                ...
                <h3 style={{ color: 'var(--azul-oscuro)', marginTop: '2rem', marginBottom: '1rem' }}>2. Uso de la Información</h3>
                <p style={{ marginBottom: '1.5rem', lineHeight: '1.8' }}>
                    La información que recopilamos de usted puede ser utilizada para:
                </p>
                <ul style={{ paddingLeft: '2rem', marginBottom: '1.5rem', lineHeight: '1.8' }}>
                    ...
                    <li>Mejorar nuestro sitio web y los servicios de consultoría.</li>
                    <li>Mejorar el servicio al cliente y las necesidades de soporte técnico.</li>
                    <li>Enviar correos electrónicos periódicos sobre nuestras publicaciones del blog o promociones.</li>
                </ul>

                <h3 style={{ color: 'var(--azul-oscuro)', marginTop: '2rem', marginBottom: '1rem' }}>3. Protección y Almacenamiento</h3>
                <p style={{ marginBottom: '1.5rem', lineHeight: '1.8' }}>
                    Implementamos una variedad de medidas de seguridad de alto nivel tecnológico para mantener la seguridad de su información personal. No vendemos, intercambiamos ni transferimos por ningún motivo a terceros partes su información de identificación personal. Esto no incluye a terceros de confianza que nos asisten en operar nuestro sitio web o llevar a cabo nuestro negocio, siempre que dichas partes acepten mantener esta información estrictamente confidencial.
                </p>
