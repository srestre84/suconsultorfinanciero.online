    ...
    return (
        <section className="consulting-section section-padding container">
            <div className="glass" style={{ padding: '3rem 2rem', borderRadius: '20px', textAlign: 'center', background: 'linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(240,248,255,0.95) 100%)', boxShadow: '0 15px 35px rgba(0, 0, 0, 0.05)' }}>
                ...
                <div className="animate-fade-in delay-3" style={{ background: 'var(--azul-oscuro)', padding: '2rem', borderRadius: '15px', color: 'white', maxWidth: '600px', margin: '0 auto' }}>
                    <h3 style={{ color: 'var(--mostaza)', marginBottom: '1rem', fontSize: '1.5rem' }}>¿Necesitas una Sesión de Trabajo?</h3>
                    <p style={{ marginBottom: '1.5rem', fontSize: '1.1rem' }}>Agenda una consultoría 1 a 1 para estructurar un plan de acción real, basado en números, no en intuición.</p>
                    ...
                    <a
                        ...
                        style={{ display: 'inline-block', fontSize: '1.1rem', padding: '0.8rem 2rem', backgroundColor: 'var(--mostaza)', color: 'var(--azul-oscuro)', fontWeight: 'bold' }}
                    >
